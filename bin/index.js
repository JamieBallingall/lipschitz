...
TestAll.prototype = {
	testCircle: function() {
		...
		utest_Assert.isTrue(c(0,0) < 0,null,{ fileName : "TestAll.hx", lineNumber : 11, className : "TestAll", methodName : "testCircle"});
		utest_Assert.isTrue(c(10,10) > 0,null,{ fileName : "TestAll.hx", lineNumber : 12, className : "TestAll", methodName : "testCircle"});
		var cc = lip_shapes_Boolean.union(c,c);
		utest_Assert.isTrue(cc(0,0) < 0,null,{ fileName : "TestAll.hx", lineNumber : 14, className : "TestAll", methodName : "testCircle"});
		utest_Assert.isTrue(cc(10,10) > 0,null,{ fileName : "TestAll.hx", lineNumber : 15, className : "TestAll", methodName : "testCircle"});
	}
	,__class__: TestAll
};
