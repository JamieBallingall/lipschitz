...
lip_Grid.prototype = {
	...
	,paintCircle: function(row,col,radius) {
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var y = _g3++;
				this.setSymmetrics(row,col,y,x,lip_PointStatus.Interior(lip_PointValue.Inferred));
			}
		}
		this.setAt(row,col,absradius == 0 ? lip_PointStatus.Exterior(lip_PointValue.Evaluated(radius)) : lip_PointStatus.Interior(lip_PointValue.Evaluated(radius)));
	}
