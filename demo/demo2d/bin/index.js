...
Demo.main = function() {
	...
	minicanvas_MiniCanvas.create(grid.cols,grid.rows).grid().border(1,Demo.border).box(function(x,y) {
		...
		case 0:
			return Demo.unknown;
		case 1:
			return Demo.interior;
		case 2:
			return Demo.exterior;
		}
...
lip_Grid.prototype = {
	...
	,paintCircle: function(row,col,radius) {
		...
		var inferred = radius <= 0 ? lip_Grid.interiorInferred : lip_Grid.exteriorInferred;
		var _g1 = 0;
		var _g = absradius;
		while(_g1 < _g) {
			var x = _g1++;
	...
	,setSymmetrics: function(row,col,drow,dcol,value) {
		if(drow == 0 && dcol == 0) {
			...
			this.setAt(row,col + dcol,value);
			this.setAt(row,col - dcol,value);
		} else if(dcol == 0) {
			this.setAt(row + drow,col,value);
			this.setAt(row - drow,col,value);
		} else {
			this.setAt(row + drow,col + dcol,value);
			this.setAt(row + drow,col - dcol,value);
			this.setAt(row - drow,col + dcol,value);
			this.setAt(row - drow,col - dcol,value);
		}
...
lip__$Shape_Shape_$Impl_$.or = function(this1,other) {
	return lip_shapes_Boolean.union(this1,other);
};
lip__$Shape_Shape_$Impl_$.and = function(this1,other) {
	return lip_shapes_Boolean.intersection(this1,other);
};
lip__$Shape_Shape_$Impl_$.difference = function(this1,other) {
	return lip_shapes_Boolean.difference(this1,other);
};
...
lip__$Shape3_Shape3_$Impl_$.or = function(this1,other) {
	return lip_shapes_Boolean.union3(this1,other);
};
lip__$Shape3_Shape3_$Impl_$.and = function(this1,other) {
	return lip_shapes_Boolean.intersection3(this1,other);
};
lip__$Shape3_Shape3_$Impl_$.difference = function(this1,other) {
	return lip_shapes_Boolean.difference3(this1,other);
};
...
lip_shapes_Boolean.intersection3 = function(a,b) {
	return function(xx,yy,zz) {
		return Math.max(a(xx,yy,zz),b(xx,yy,zz));
	};
};
lip_shapes_Boolean.difference3 = function(a,b) {
	return function(xx,yy,zz) {
		return Math.max(a(xx,yy,zz),-b(xx,yy,zz));
	};
};
lip_shapes_Boolean.complement3 = function(a) {
	return function(xx,yy,zz) {
		return -a(xx,yy,zz);
	};
};
...
lip_Grid.interiorInferred = lip_PointStatus.Interior(lip_PointValue.Inferred);
lip_Grid.exteriorInferred = lip_PointStatus.Exterior(lip_PointValue.Inferred);
